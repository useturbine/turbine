from src.integration.postgres import Postgres
...
# create a collection
dimension = 128
client.create_collection("collection1", params={
    "fields": [
...
client.insert(collection="collection1", params={
    "fields": [
...
client.create_index(collection="collection1", field="vector", params={
    "index_type": "IVF_SQ8",
    "metric_type": "L2",
    "params": {"nlist": 2048}
}, index_name="index1")
...
top_k = 10
results = client.search(collection="collection1", field="vector", data=query_embedding, top_k=top_k, params={
    "metric_type": "L2",
    "params": {"nprobe": 10}
})
